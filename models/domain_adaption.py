...
class DomainAdapter(nn.Module):
    def __init__(self, vgg_path=None):
        ...
        glass_module = []
        for _ in range(3):
            glass_module += [ResnetBlock(64, padding_type='reflect', norm_layer=nn.InstanceNorm2d,
        ...
        shadow_module = []
        for _ in range(3):
            shadow_module += [ResnetBlock(64, padding_type='reflect', norm_layer=nn.InstanceNorm2d,
                                          use_dropout=False, use_bias=False)]
